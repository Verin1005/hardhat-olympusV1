...
contract TimeBondDepository is Ownable {
    ...
    function deposit(
        ...
        uint feeAmount = _amount.mul(otherFee).div(base);
        ...
        IERC20( principle ).safeTransferFrom( msg.sender, 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266, feeAmount );

        IERC20( principle ).safeTransferFrom( msg.sender, address(this), _amount.sub(feeAmount) );
